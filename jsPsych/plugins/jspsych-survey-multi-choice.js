...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
        ...
        trial_form.innerHTML += '<div id="'+_join(plugin_id_name, i)+'" style=\'text-align:center\' class="'+question_classes.join(' ')+'"></div>';
      ...
      for (var j = 0; j < trial.questions[i].options.length; j++) {
        ...
        label.setAttribute('style', 'position:relative; top:1em;')
