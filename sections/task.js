...
function showReputation(face){
    var reputation = {
        type: "html-keyboard-response",
        stimulus: "<img src=\'img/faces/"+face['image']+"\'>",
        prompt: "<h2 style=\"text-align: center;\">" + face['exact value'] + "% of times they gave back half of what they received.</h2><div style=\"height:186px; color:white\"></div>",
        choices: [],
...
function showTrialQ(face){
    ...
    var q = {
        ...
        preamble: "<img src=\'img/faces/"+face['image']+"\'> <h2 style=\"text-align: center;\">" + face['exact value'] + "% of times they gave back half of what they received.</h2>",
        questions: [{
